...
const Footer: React.FC = () => {
  return (
    <footer className="relative bg-white pt-10 pb-6 border-t border-transparent  w-full">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 px-6 relative z-10">
        <div>
          ...
          <p className="text-sm text-gray-700">Международные автобусные перевозки.</p>
        </div>
